                ...
                child: Column(
                  ...
                  children: [
                    if (fetched && article.content?.content != null) ...[
                      if (
                        (articleType == "Blog" || articleType == "Coluna") && 
                        article.author != null && 
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 16),
                                          Text(
                                            article.author!.list!.first.name?.replaceAll("&#039;", "'") ?? "",
                                            style: const TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.w700,
                                              color: Colors.white,
                                          ...
                                          Wrap(
                                            ...
                                            children: [
                                              if (article.author!.list!.first.social?.instagram != "" && article.author!.list!.first.social?.instagram != null) ...[
                                                _buildSocialIcon(
                                                  article.author!.list!.first.social?.instagram, 
                                                  'https://www.cnnbrasil.com.br/wp-content/client-mu-plugins/cnn-blogs/img/instagram_cnn.svg'
                                                ),
                                              ],
                                              if (article.author!.list!.first.social?.twitter != "" && article.author!.list!.first.social?.twitter != null) ...[
                                                _buildSocialIcon(
                                                  article.author!.list!.first.social?.twitter, 
                                                  'https://www.cnnbrasil.com.br/wp-content/client-mu-plugins/cnn-blogs/img/x_twitter_cnn.svg'
                                                ),
                                              ],
                                              if (article.author!.list!.first.social?.linkedin != "" && article.author!.list!.first.social?.linkedin != null) ...[
                                                _buildSocialIcon(
                                                  article.author!.list!.first.social?.linkedin, 
                                                  'https://www.cnnbrasil.com.br/wp-content/client-mu-plugins/cnn-blogs/img/linkedin_cnn.svg'
                                                ),
                                              ],
                                              if (article.author!.list!.first.social?.youtube != "" && article.author!.list!.first.social?.youtube != null) ...[
                                                _buildSocialIcon(
                                                  article.author!.list!.first.social?.youtube, 
                                                  'https://www.cnnbrasil.com.br/wp-content/client-mu-plugins/cnn-blogs/img/youtube_cnn.svg'
                                                ),
                                              ],
                                              if (article.author!.list!.first.social?.tiktok != "" && article.author!.list!.first.social?.tiktok != null) ...[
                                                _buildSocialIcon(
                                                  article.author!.list!.first.social?.tiktok, 
                                                  'https://www.cnnbrasil.com.br/wp-content/client-mu-plugins/cnn-blogs/img/tiktok_cnn.svg'
                                                ),
                                              ],
                                              InkWell(
                                                onTap: () {
                                                  Clipboard.setData(ClipboardData(text: articleUrl.replaceAll("?hidemenu=true", "")));
                                                },
                                                child: Container(
                                                  width: 24,
                                                  height: 24,
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                NavigatorManager(context).to(
                                  Article.route,
                                  data: ArticleSettings(articleId: articlesMostRead.posts.first.slug!, articleUrl: ""),
                                  onFinished: () {},
                                );
                              },
                              child: Column(
                            ...
                            for (int index = 0;
                              ...
                              InkWell(
                                onTap: () {
                                  NavigatorManager(context).to(
                                    Article.route,
                                    data: ArticleSettings(articleId: articlesMostRead
                                        .posts[index + 1].slug!, articleUrl: ""),
                                    onFinished: () {},
                                  );
                                },
                                child: Row(
